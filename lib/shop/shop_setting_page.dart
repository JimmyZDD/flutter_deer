...
import 'widgets/send_type_dialog.dart';
...
class _ShopSettingPageState extends State<ShopSettingPage> {
  ...
  final String _address = '陕西省 西安市 长安区 郭杜镇郭北村韩林路圣方医院斜对面';
          ...
          children: <Widget>[
            ...
            Visibility(
              ...
              child: ClickItem(
                  ...
                  onTap: () {
                    Get.to(const FreightConfigPage());
  ...
  void _goInputTextPage(BuildContext context, String title, String hintText,
      String content, Function(Object?) function,
