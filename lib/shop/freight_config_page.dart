...
import 'widgets/range_price_input_dialog.dart';
...
class FreightConfigPage extends StatefulWidget {
  ...
  @override
  State<FreightConfigPage> createState() => _FreightConfigPageState();
}
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color:
                      context.isDark ? Colours.dark_bg_gray : Colours.bg_gray,
                      ...
                      children: <Widget>[
                        ...
                        Expanded(
                          ...
                          child: InkWell(
                            ...
                            child: Text(
                              _getPriceText(index).isEmpty
                                  ? '订单金额'
                                  : _getPriceText(index),
                              key: Key('订单金额$index'),
                              textAlign: TextAlign.end,
                              style: _getPriceText(index).isEmpty
                                  ? Theme.of(context)
                                      .textTheme
                                      .titleSmall
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        Expanded(
                            child: Semantics(
                          label:
                              '填写${_list[index].type == 1 ? '运费比率' : '运费金额'}',
                          child: InkWell(
                            onTap: () => _showFreightInputDialog(index),
                            child: Text(
                              _list[index].price.isEmpty
                                  ? (_list[index].type == 1 ? '运费比率' : '运费金额')
                                  : _list[index].price,
                              textAlign: TextAlign.end,
                              style: _list[index].price.isEmpty
                                  ? Theme.of(context)
                                      .textTheme
                                      .titleSmall
                                      ?.copyWith(fontSize: Dimens.font_sp14)
