/*
 * @Author: zdd
 * @Date: 2023-04-17 11:52:25
 * @LastEditors: zdd
 * @LastEditTime: 2023-04-17 22:18:02
 * @FilePath: /flutter_deer/packages/gen_cli/lib/cli_config/cli_config.dart
 * @Description: 
 */
import 'dart:io';
...
class CliConfig {
  ...
  static File getFileConfig() {
    ...
    var path = join(dirname(scriptFile), '.gen_cli.yaml');
